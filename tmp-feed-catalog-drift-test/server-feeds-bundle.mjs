...
function isServerFeedReachableForLanguage(feed, language) {
  return !feed.lang || feed.lang === language || !!feed.strategicDefault;
}
function orderServerFeedEntries(entries) {
  return entries.map((entry, index) => ({ entry, index })).sort((a, b) => {
    const aPriority = Number.isFinite(a.entry.feed.deadlinePriority) ? a.entry.feed.deadlinePriority : 0;
    const bPriority = Number.isFinite(b.entry.feed.deadlinePriority) ? b.entry.feed.deadlinePriority : 0;
...
var gnLocale = (q, hl, gl, ceid) => `https://news.google.com/rss/search?q=${encodeURIComponent(q)}&hl=${hl}&gl=${gl}&ceid=${ceid}`;
var VARIANT_FEEDS = {
  full: {
    politics: [
    ...
    europe: [
      ...
      { name: "H\xEDrad\xF3", url: gnLocale("site:hirado.hu when:2d", "hu", "HU", "HU:hu"), lang: "hu" },
      ...
      { name: "Seznam Zpr\xE1vy", url: "https://www.seznamzpravy.cz/rss", lang: "cs" },
    ...
    turkiye: [
      ...
      { name: "TRT Haber D\xFCnya", url: "https://www.trthaber.com/dunya_articles.rss", lang: "tr" },
      { name: "NTV", url: "https://www.ntv.com.tr/gundem.rss", lang: "tr" },
      { name: "Habert\xFCrk", url: "https://www.haberturk.com/rss", lang: "tr", deadlinePriority: 1 },
      { name: "Habert\xFCrk D\xFCnya", url: "https://www.haberturk.com/rss/kategori/dunya.xml", lang: "tr" },
      { name: "S\xF6zc\xFC", url: "https://www.sozcu.com.tr/feeds-rss-category-sozcu", lang: "tr" },
      ...
      { name: "Euronews T\xFCrk\xE7e", url: "https://tr.euronews.com/rss", lang: "tr" },
      { name: "BBC T\xFCrk\xE7e", url: "https://feeds.bbci.co.uk/turkce/rss.xml", lang: "tr" },
      { name: "DW T\xFCrk\xE7e", url: "https://rss.dw.com/xml/rss-tur-all", lang: "tr" },
      { name: "Bloomberg HT", url: "https://www.bloomberght.com/rss", lang: "tr" },
      { name: "D\xFCnya Gazetesi", url: "https://www.dunya.com/rss", lang: "tr" },
      { name: "Yeni \u015Eafak", url: "https://www.yenisafak.com/rss", lang: "tr" },
      { name: "Independent T\xFCrk\xE7e", url: "https://www.indyturk.com/rss.xml", lang: "tr" },
      ...
      { name: "BirG\xFCn", url: "https://www.birgun.net/rss/home", lang: "tr" },
      ...
      { name: "Yeni\xE7a\u011F", url: "https://www.yenicaggazetesi.com.tr/rss", lang: "tr" },
    ...
    africa: [
      ...
      { name: "A\xEFr Info", url: "https://airinfoagadez.com/feed/", lang: "fr" },
