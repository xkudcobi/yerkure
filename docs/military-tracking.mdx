...
For a step-by-step map workflow and an explanation of source coverage and history limits, read the [military flight-tracking guide for OSINT](https://www.worldmonitor.app/blog/posts/military-flight-tracking-osint/).
...
Surge detection groups activity into a simplified primary-theater set for baseline comparison, distinct from the more detailed theater registries used elsewhere:
