...
- [Economic service](https://github.com/koala73/worldmonitor/blob/main/docs/api/EconomicService.openapi.yaml) — includes `GetEnergyCrisisPolicies` and the broader energy / macro family.
