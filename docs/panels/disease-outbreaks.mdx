...
- [Health service](https://github.com/koala73/worldmonitor/blob/main/docs/api/HealthService.openapi.yaml) — covers `list-disease-outbreaks` and `list-air-quality-alerts`.
