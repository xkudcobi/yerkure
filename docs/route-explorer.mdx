...
For the API-level contract, see the [Supply Chain](https://github.com/koala73/worldmonitor/blob/main/docs/api/SupplyChainService.openapi.yaml) and [Shipping v2](/api-shipping-v2) reference pages. For the underlying maritime layer on the map, see [Maritime Intelligence](/maritime-intelligence).
