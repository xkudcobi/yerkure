---
title: "Yerküre REST API versioning"
...
When Yerküre replaces or retires a public REST version or operation:
...
RFC 9745 allows a `Link` with `rel="deprecation"` without a `Deprecation` header, so agents can find this policy before any surface is retired. Current Yerküre API and homepage responses may include:
