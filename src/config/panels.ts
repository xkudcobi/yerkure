...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  turkiye: { name: 'Türkiye', enabled: true, priority: 1 },
...
const FULL_MAP_LAYERS: MapLayers = {
  ...
  canadaRoads: false,
  canadaAlerts: false, // Yerküre: Türkiye odaklı kurulumda varsayılan kapalı (performans uyarısını da tetikliyordu)
  economic: true,
  waterways: true,
  outages: true,
  cyberThreats: false,
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  regionalNews: {
    ...
    panelKeys: ['politics', 'turkiye', 'us', 'europe', 'middleeast', 'africa', 'latam', 'asia'],
    variants: ['full'],
  },
  marketsFinance: {
